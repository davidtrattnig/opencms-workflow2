...
/**
 * WorkflowRejectNotPermittedException
 * <p>
 * @author david.trattnig
 * 
 */
public class WorkflowRejectNotPermittedException extends Exception {
	private static final long serialVersionUID = 1L;
		
	/**
	 * Constructor for the WorkflowException 
	 */
	public WorkflowRejectNotPermittedException() {
		super();
	 ...
	 */
	public WorkflowRejectNotPermittedException(String message) {
		super(message);
		// TODO Auto-generated constructor stub
	}
	 ...
	 */
	public WorkflowRejectNotPermittedException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
	 ...
	 */
	public WorkflowRejectNotPermittedException(String message, Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}
