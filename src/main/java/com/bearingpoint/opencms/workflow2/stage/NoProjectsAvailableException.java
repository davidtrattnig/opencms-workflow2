 ...
 * 
 */
public class NoProjectsAvailableException extends Exception {
	private static final long serialVersionUID = 1L;
		
	/**
	 * Constructor for the WorkflowException 
	 */
	public NoProjectsAvailableException() {
		super();
	 ...
	 */
	public NoProjectsAvailableException(String message) {
		super(message);
		// TODO Auto-generated constructor stub
	}
	 ...
	 */
	public NoProjectsAvailableException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
	 ...
	 */
	public NoProjectsAvailableException(String message, Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}
