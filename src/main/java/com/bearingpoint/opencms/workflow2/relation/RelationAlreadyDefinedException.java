 ...
 * 
 */
public class RelationAlreadyDefinedException extends Exception {
	private static final long serialVersionUID = 1L;
		
	/**
	 * Constructor for the WorkflowException 
	 */
	public RelationAlreadyDefinedException() {
		super();
	 ...
	 */
	public RelationAlreadyDefinedException(String message) {
		super(message);
		// TODO Auto-generated constructor stub
	}
	 ...
	 */
	public RelationAlreadyDefinedException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
	 ...
	 */
	public RelationAlreadyDefinedException(String message, Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}
