 ...
 * 
 */
public class NoEngineAttachedException extends Exception {
	private static final long serialVersionUID = 1L;
		
	/**
	 * Constructor for the WorkflowException 
	 */
	public NoEngineAttachedException() {
		super();
	 ...
	 */
	public NoEngineAttachedException(String message) {
		super(message);
		// TODO Auto-generated constructor stub
	}
	 ...
	 */
	public NoEngineAttachedException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
	 ...
	 */
	public NoEngineAttachedException(String message, Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}
