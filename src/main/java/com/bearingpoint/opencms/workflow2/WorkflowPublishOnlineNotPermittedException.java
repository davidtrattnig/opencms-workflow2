...
/**
 * WorkflowPublishOnlineNotPermittedException
 * <p>
 * @author david.trattnig
 * 
 */
public class WorkflowPublishOnlineNotPermittedException extends Exception {
	private static final long serialVersionUID = 1L;
		
	/**
	 * Constructor for the WorkflowException 
	 */
	public WorkflowPublishOnlineNotPermittedException() {
		super();
	 ...
	 */
	public WorkflowPublishOnlineNotPermittedException(String message) {
		super(message);
		// TODO Auto-generated constructor stub
	}
	 ...
	 */
	public WorkflowPublishOnlineNotPermittedException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
	 ...
	 */
	public WorkflowPublishOnlineNotPermittedException(String message, Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}
