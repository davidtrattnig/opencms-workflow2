<%@ page import="com.bearingpoint.opencms.workflow.Messages" %>
<%@ page import="com.bearingpoint.opencms.workflow.WorkflowView" %>
<%@ page import="com.bearingpoint.opencms.workflow.task.I_Task" %>
<%@ page import="com.bearingpoint.opencms.workflow.task.TaskComment" %>
...
<div>
	...
	<table cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td><% if (task.getActorId()==null) { %><%= task.getPooledGroupId() %><% } else {%><%=task.getActorId() %><% } %></td>				
		</tr>
		<tr>
